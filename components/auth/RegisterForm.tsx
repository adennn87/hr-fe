  ...
  return (
    <div className="animate-in slide-in-from-right-8 duration-500 w-full max-w-2xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <Button variant="ghost" onClick={onBack} className="text-slate-500 hover:text-blue-600 gap-2">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div className="bg-slate-50/50 p-6 rounded-2xl border border-slate-100 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="space-y-2">
              ...
              <Input {...register("full_name")} placeholder="Nguyen Van A" className={errors.full_name ? "border-red-500" : ""} />
        ...
        <div className="bg-slate-50/50 p-6 rounded-2xl border border-slate-100 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input {...register("phoneNumber")} placeholder="0912..." className={`pl-10 ${errors.phoneNumber ? "border-red-500" : ""}`} />
        ...
        <div className="bg-slate-50/50 p-6 rounded-2xl border border-slate-100 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input {...register("email")} type="email" placeholder="name@company.com" className={errors.email ? "border-red-500" : ""} />
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2 mt-2 flex-wrap">
                {requirements.map((req, i) => {
                  ...
                  return (
                    <span key={i} className={`text-[10px] px-2 py-0.5 rounded-full border transition-all ${isMet ? 'bg-emerald-100 border-emerald-200 text-emerald-700 font-bold' : 'bg-slate-100 border-slate-200 text-slate-400'}`}>
                      {req.label} {isMet && "✓"}
                    </span>
                  )
                })}
